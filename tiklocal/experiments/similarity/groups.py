...
from . import (
    DEFAULT_SIMILARITY_THRESHOLD, DEFAULT_SIMILARITY_SCAN_LIMIT,
    DEFAULT_SIMILARITY_GROUP_LIMIT, DEFAULT_SIMILARITY_MIN_GROUP_SIZE,
    DEFAULT_SIMILARITY_MAX_GROUP_SIZE, SIMILARITY_KIND_IMAGE_EMBEDDING,
)
