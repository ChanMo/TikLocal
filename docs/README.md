...
- `docs/flow-interaction-unification.md`：Flow / Library / Favorites 统一交互内核设计与落地说明。
- `docs/media-index-and-recommendation.md`：媒体索引、安全同步、缩略图与本地推荐的数据流及实现边界。
- `docs/radio-native-client-architecture.md`：TikLocal Radio 原生客户端的产品边界、代码复杂度约束与发布路径。
